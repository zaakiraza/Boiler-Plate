...
function ForgotPassword() {
  ...
  const handleOtpRequest = async () => {
    ...
    try {
      const response = await axios.post(
        "https://hackathonbackend-ebon.vercel.app/api/auth/forgotPasswordOtp",
        {
          email: email,
        }
      );
  ...
  const handleResetRequest = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://hackathonbackend-ebon.vercel.app/api/auth/verifyforgotPasswordOtp",
        { email, otp }
      );
      setMessage(response.data.message);
      setOtp("");
      ...
      const api = await axios.post(
        "https://hackathonbackend-ebon.vercel.app/api/auth/forgotPassword",
        {
          email,
        }
      );
